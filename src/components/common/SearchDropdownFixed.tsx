...
const SearchDropdown: React.FC<SearchDropdownProps> = ({
	...
	const displayProducts = hasMoreResults
				...
				<Box {...dropdownContainerCss}>
					{isLoading || isFetching ? (
						...
						<VStack gap={0} align='stretch'>
							...
							{/* View More Button */}
							{hasMoreResults && (
								<Box {...moreBoxCss} onClick={handleViewMore}>
...
const dropdownContainerCss: BoxProps = {
	position: 'absolute',
	top: '100%',
	left: 0,
	right: 0,
