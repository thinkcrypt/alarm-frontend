...
import {
	deleteSingleItemNowFromCart as deleteSingleItemFromCart,
	deleteOneFromNowCart as deleteOneFromCart,
	addToNowCart as addToCartAction,
...
export default BuyNowCartItems;
