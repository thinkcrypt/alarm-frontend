...
import ProductAddToCartModal from '../ProductPage/ProductAddToCartModal';
...
const BuyNowDialog: React.FC<BuyNowDialogProps> = ({ product, trigger }: any) => {
			...
			<Portal>
				...
				<Dialog.Positioner>
					<Dialog.Content
						...
						shadow='lg'
						overflow='auto'>
						<ProductAddToCartModal productData={product} />
